/**
 * A cleaned up version of the original code can be found below. Cleanup includes:
 * 1. Including more libraries to suppress undefined warnings
 * 2. Added braces to for loops for clarity
 * 3. Fixed bug in main function where calling A3A8 had key and rand swapped
*/
...
/*
 * For expository purposes only.  Coded in C merely because C is a much1
...
int main(int argc, char **argv)
{
	...
	//Original Call swaps key and rand. Fixed.
